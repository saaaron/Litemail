<?php 
	...
	// select posts 
	$select_starred = "SELECT * FROM mails WHERE user_id = ? AND subject != '' AND starred = 'yes' AND recycled = 'no' ORDER BY date_n_time DESC";
	$stmt = mysqli_prepare($db, $select_starred);
	...
	$query = "SELECT * FROM mails WHERE user_id = ? AND subject != '' AND starred = 'yes' AND recycled = 'no'";
