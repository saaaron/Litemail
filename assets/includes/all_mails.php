<?php 
	...
	// select posts 
	$select_all_mails = "SELECT * FROM mails WHERE user_id = ? AND subject != '' AND recycled = 'no' ORDER BY date_n_time DESC";
	$stmt = mysqli_prepare($db, $select_all_mails);
	...
	$query = "SELECT * FROM mails WHERE user_id = ? AND subject != '' AND recycled = 'no'";
