<?php
	...
	include "../assets/includes/m_format_time_function.php";
...
<head>
	...
	<title>'.$vfrom_user_full_name.': '.$vmail_subject.'</title>
		...
		<div class="mr-0">
		    <div class="dropdown profile-prev-head">
		    	<a href="#" class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expended="false">	
		    		<div class="d-flex align-items-center">
					    ...
					    <div class="d-flex justify-content-start">
					    	<div class="d-none d-sm-block d-sm-none d-md-block me-1"><b>'.$user_full_name.'</b></div>
			    ...
			    <ul class="dropdown-menu p-2 shadow" style="width: 200px;">
					...
					<li class="d-md-none d-lg-block d-lg-none d-xl-block d-xl-none d-xxl-block d-xxl-none"><a class="dropdown-item rounded-2 mb-1" href="../all_mails"><span class="bi-mailbox"></span> All mails <span class="text-danger total_all_mails_count">'.$total_num_of_all_mails_sidebar.'</span></a></li>
